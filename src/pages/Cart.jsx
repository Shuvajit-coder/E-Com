    ...
    <div className="mt-10 max-w-6xl mx-auto mb-5 px-4 md:px-0">
      {cartItem.length > 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-20">
              ...
              <div className="bg-white border border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <p className="font-semibold text-lg">${finalPrice + 5}</p>
                </div>
                <div>
        ...
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-4 text-center">
          <h1 className="text-red-500 font-bold text-3xl sm:text-4xl md:text-5xl mb-4">
          ...
          <button
            ...
            className="mt-6 bg-red-500 hover:bg-red-600 transition text-white px-6 py-3 rounded-md font-medium"
          >
            Continue Shopping
          </button>
        </div>
